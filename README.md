...
## Installation
1. Install Minecraft Forge 1.20.1 (version 47.0.0 or higher)
2. Download [Cloth Config](https://www.curseforge.com/minecraft/mc-mods/cloth-config-forge) for Forge
3. Download this mod from the releases
...
## Acknowledgements
- **Original Fabric mod** by [xiaocihua](https://github.com/xiaocihua) - [Stack to Nearby Chests](https://github.com/xiaocihua/stack-to-nearby-chests)
- All the [**contributors**](https://github.com/xiaocihua/stack-to-nearby-chests/graphs/contributors) to the original Fabric mod. Please accept my heartfelt thanks.
- [clientcommands](https://github.com/Earthcomputer/clientcommands)
- [MonsterTrex](https://github.com/MonsterTrex), for providing valuable advice
