...
public class ForEachEntityContainerTask extends ForEachContainerTask {
    ...
    public ForEachEntityContainerTask(Minecraft client,
        ...
        Predicate<Entity> entityPredicate = EntitySelector.CONTAINER_ENTITY_SELECTOR
                ...
                .and(entity -> filter.contains(ForgeRegistries.ENTITY_TYPES.getKey(entity.getType()).toString()))
                .and(entity -> !(entity instanceof Donkey donkey) || donkey.hasChest());

        entities = world
                .getEntities(cameraEntity, getBox(cameraEntity.getEyePosition(0), reachDistance), entityPredicate)
                .iterator();
    }
